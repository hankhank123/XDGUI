sap.ui.define([
	...
	return BaseObject.extend("ztest100.model.GroupSortState", {
		 ...
		 * @class
		 * @public
		 * @alias ztest100.model.GroupSortState
		 */
		...
		group: function(sKey) {
			...
			if (sKey === "") {
				...
				this._oViewModel.setProperty("/sortBy", "Belnr");
			}
