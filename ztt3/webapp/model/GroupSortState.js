sap.ui.define([
	...
	return BaseObject.extend("ztt3.ztt3.model.GroupSortState", {
		 ...
		 * @class
		 * @public
		 * @alias ztt3.ztt3.model.GroupSortState
		 */
		...
		/**
		 * Groups by ID, or resets the grouping for the key "None"
		 *
		 * @param sKey - the key of the field used for grouping
		 * @returns {sap.ui.model.Sorter[]} an array of sorters
		 */
